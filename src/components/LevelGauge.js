  ...
  return (
    <View style={styles.wrap}>
      <Svg width="100%" height="238" viewBox="0 0 360 238">
        ...
        <Path d="M41 194 A139 139 0 0 1 319 194" fill="none" stroke={theme.accentPrimary} strokeWidth="12" strokeDasharray="300 450" strokeLinecap="butt" />
      </Svg>
      <View style={styles.center}>
        <LinearGradient colors={[theme.backgroundSoft, theme.accentGlow]} style={styles.glowDisc}>
          ...
          <Text style={[styles.level, { color: theme.text }]}>NIV. {currentUser.level}</Text>
        </LinearGradient>
      </View>
      <View style={[styles.endpoint, styles.left]}>
        <Text style={[styles.endpointLabel, { color: theme.text }]}>NIV. 38</Text>
        <Text style={[styles.endpointValue, { color: theme.text }]}>47 500</Text>
      </View>
      <View style={[styles.endpoint, styles.right]}>
        <Text style={[styles.endpointLabel, { color: theme.text }]}>NIV. 39</Text>
        <Text style={[styles.endpointValue, { color: theme.text }]}>50 000</Text>
      </View>
    </View>
  );
}
